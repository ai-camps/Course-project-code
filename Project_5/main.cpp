// **********************************
// * Project 5
// * Use PWM (Pulse Width Modulation, 8-bit resolution) to control LED and the buzzer
// **********************************
...
// PWM settings for LED and Buzzer
...
void loop()
{
  ...
  if (WiFi.status() == WL_CONNECTED)
  {
    ...
    // Print current WiFi SSID, IP address, current date, and time

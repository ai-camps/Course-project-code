...
<body>
    <div class="dashboard">
        ...
        <div class="sensor-grid">
            ...
            <div class="sensor-card">
                <div class="sensor-name">Data sent to AWS</div>
                <div class="sensor-value mqtt-failure" id="mqtt-status">Failure</div>
            </div>
            <div class="sensor-card">
        ...
        function updateSensorData() {
            fetch('/data')
                ...
                .then(data => {
                    ...
                    document.getElementById('mqtt-status').textContent = data.mqttStatus ? 'Success' : 'Failure';
                    document.getElementById('mqtt-status').className = data.mqttStatus ? 'mqtt-success' : 'mqtt-failure';

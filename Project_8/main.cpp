...
#include "logo.h"  // Includes the logo header file
...
void displayLogo();             // Declares the function to display the logo on the OLED
...
{
  display.clearDisplay();
  display.drawBitmap(0, 0, epd_bitmap_Group_1, SCREEN_WIDTH, SCREEN_HEIGHT, SSD1306_WHITE);
  display.display();
}
...
void initOLED()
{
  ...
  // Display logo at initialization
  displayLogo();
}

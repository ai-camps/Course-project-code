...
bool readAndDisplayTiltSensor()
{
    ...
    Serial.println(tiltState ? "Tilted" : "Not Tilted");

    // Print to OLED
    display.setCursor(0, 32);
    display.print("Tilt Sensor: ");
    display.println(tiltState ? "Tilted" : "Not Tilted");
    display.display();

    return tiltState; // Return the state of the tilt sensor
}
...
bool readAndDisplayMotionSensor()
{
    ...
    display.println(motionState ? "Motion Detected" : "No Motion");
    display.display();

    return motionState; // Return the state of the motion sensor
}
...
bool readAndDisplayFlameSensor()
{
    ...
    Serial.println(flameState ? "Flame Detected" : "No Flame");

    // Print to OLED
    display.setCursor(0, 52);
    display.print("Flame Sensor: ");
    display.println(flameState ? "Flame Detected" : "No Flame");
    display.display();

    return flameState; // Return the state of the flame sensor
}
